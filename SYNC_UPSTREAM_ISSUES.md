# Upstream Issues to Sync

This document contains 16 issues from the upstream `paulnasca/paulstretch_cpp` repository that need to be created in this fork.

## Issues to Create

### Issue 1: Paulstretch segmentation fault
- **Upstream Link:** https://github.com/paulnasca/paulstretch_cpp/issues/18
- **Author:** @dblanchemain
- **Body:**
```
...
- **Upstream Link:** https://github.com/paulnasca/paulstretch_cpp/pull/17
- **Author:** @ttsiodras
- **Body:**
```
[Synced from upstream]
...
- **Upstream Link:** https://github.com/paulnasca/paulstretch_cpp/issues/16
- **Author:** @hebronwatson
- **Body:**
```
[Synced from upstream]
...
- **Upstream Link:** https://github.com/paulnasca/paulstretch_cpp/issues/15
...
- **Upstream Link:** https://github.com/paulnasca/paulstretch_cpp/issues/14
- **Author:** @Jamaldude
- **Body:**
```
[Synced from upstream]
...
- **Upstream Link:** https://github.com/paulnasca/paulstretch_cpp/pull/12
- **Author:** @afontenot
- **Body:**
```
[Synced from upstream]
...
- **Upstream Link:** https://github.com/paulnasca/paulstretch_cpp/issues/10
- **Author:** @nebosite
- **Body:**
```
[Synced from upstream]
...
- **Upstream Link:** https://github.com/paulnasca/paulstretch_cpp/issues/9
- **Author:** @esaruoho
- **Body:**
```
[Synced from upstream]
...
- **Upstream Link:** https://github.com/paulnasca/paulstretch_cpp/pull/8
- **Author:** @Chaircrusher
- **Body:**
```
[Synced from upstream]
...
- **Upstream Link:** https://github.com/paulnasca/paulstretch_cpp/pull/7
- **Author:** @Chaircrusher
- **Body:**
```
[Synced from upstream]
...
- **Upstream Link:** https://github.com/paulnasca/paulstretch_cpp/pull/6
- **Author:** @trebmuh
- **Body:**
```
[Synced from upstream]
...
- **Upstream Link:** https://github.com/paulnasca/paulstretch_cpp/pull/5
- **Author:** @trebmuh
- **Body:**
```
[Synced from upstream]
...
- **Upstream Link:** https://github.com/paulnasca/paulstretch_cpp/issues/4
- **Author:** @padsbanger
- **Body:**
```
[Synced from upstream]
...
- **Upstream Link:** https://github.com/paulnasca/paulstretch_cpp/issues/3
- **Author:** @smoge
- **Body:**
```
[Synced from upstream]
...
- **Upstream Link:** https://github.com/paulnasca/paulstretch_cpp/issues/2
- **Author:** @iioflow
- **Body:**
```
[Synced from upstream]
...
- **Upstream Link:** https://github.com/paulnasca/paulstretch_cpp/issues/1
- **Author:** @dancrew32
- **Body:**
```
[Synced from upstream]
...
Run the following command from your terminal to create all issues:
...
Navigate to https://github.com/peternicholls/paulstretch_cpp/issues/new and create each issue with the title and body provided above.
